...
public class MainFrame extends JFrame implements KeyListener {
    ...
    public void paintView() {
        ...
        if(victory()){
            // 加载胜利图片资源, 添加到窗体中
            JLabel winLabel = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\代码\\day04-code\\image\\win.png"));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                // j = 0 1 2 3
                JLabel imageLabel = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\代码\\day04-code\\image\\" + data[i][j] + ".png"));
        ...
        JLabel background = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\代码\\day04-code\\image\\background.png"));

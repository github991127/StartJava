...
public class JLabelTest {
    ...
    public static void main(String[] args) {
        ...
        // JLabel展示图片
        JLabel imgLabel_3png = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\资料\\image\\3.png"));
        imgLabel_3png.setBounds(50, 150, 100,100);
        frame.getContentPane().add(imgLabel_3png);

        JLabel imgLabel_2png = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\资料\\image\\2.png"));
        imgLabel_2png.setBounds(150, 150, 100, 100);
        frame.getContentPane().add(imgLabel_2png);

        JLabel img = new JLabel(new ImageIcon("E:\\workplace_java\\20231106_JavaHwma\\JavaHwma\\day04\\资料\\image\\win.png"));
